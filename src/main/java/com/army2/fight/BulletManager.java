...
import com.army2.fight.bullet.ApaBullet;
import com.army2.fight.bullet.BalloonLazer;
import com.army2.fight.bullet.BigBoomBum;
import com.army2.fight.bullet.BigRocKet;
import com.army2.fight.bullet.ChickyBullet;
import com.army2.fight.bullet.ItemBomB52;
import com.army2.fight.bullet.ItemBomHenGio;
import com.army2.fight.bullet.ItemBomMu;
import com.army2.fight.bullet.ItemChuotGanBom;
import com.army2.fight.bullet.ItemDongBang;
import com.army2.fight.bullet.ItemKhoangDat;
import com.army2.fight.bullet.ItemKhoangDat2;
import com.army2.fight.bullet.ItemKhoiDoc;
import com.army2.fight.bullet.ItemLaser;
import com.army2.fight.bullet.ItemMuaDan;
import com.army2.fight.bullet.ItemSaoBang;
import com.army2.fight.bullet.ItemTeleport;
import com.army2.fight.bullet.ItemTenLua;
import com.army2.fight.bullet.ItemToNhen;
import com.army2.fight.bullet.ItemTraiPha;
import com.army2.fight.bullet.ItemTuSat;
import com.army2.fight.bullet.ItemVoiRong;
import com.army2.fight.bullet.ItemXuyenDat;
import com.army2.fight.bullet.Jump;
import com.army2.fight.bullet.JumpOrFly;
import com.army2.fight.bullet.MGTBulletNew;
import com.army2.fight.bullet.MGTBulletOld;
import com.army2.fight.bullet.SmallBoomAdd;
import com.army2.fight.bullet.SmallBoomBum;
import com.army2.fight.bullet.SpiderDropSilk;
import com.army2.fight.bullet.TazranBullet;
        ...
        for (int k = 0; k < nshoot; k++) {
            switch (bull) {
                ...
                case 17:
                    ...
                    entrys.add(
                            new ApaBullet(this, (byte) 17, pl.isUsePow ? 216 : (nshoot == 2 ? 81 : 108), pl, x, y, vx, vy, 30, 100, force, force2));
                    break;
                ...
                case 49:
                    ...
                    if (ServerManager.mgtBullNew) {
                        entrys.add(
                                new MGTBulletNew(this, (byte) 49, pl.isUsePow ? 1000 : (nshoot == 2 ? 308 : 400), pl, x, y, vx, vy, 40, 70, force));
                    } else {
