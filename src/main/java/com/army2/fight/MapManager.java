    ...
    public void setMapId(int id) {
        ...
        for (i = 0; i < len; i++) {
            ...
            if (MapData.existsMapBrick(brickId)) {
                ...
                me = new MapEntry(brickId, Until.getShort(ab, off + 1), Until.getShort(ab, off + 3), mB.dat, (short) mB.Width, (short) mB.Height,
                        !MapData.isNotColision(brickId));
            } else {
                me = new MapEntry(brickId, Until.getShort(ab, off + 1), Until.getShort(ab, off + 3), null, (short) 0, (short) 0,
                        !MapData.isNotColision(brickId));
            }
            entrys.add(me);
            off += 5;
