...
import com.army2.server.ClanManager;
import com.army2.server.ItemClanData;
        ...
        if (dame > 0) {
            ...
            if (this.isDie) {
                ...
                try {
                    if (this.idNV == 26) {
                        for (int i = 0; i < 2; i++) {
                            Player players = new Ghost2(fightMNG, (byte) 26, "Ghost II", (byte) (fightMNG.allCount + fightMNG.bullMNG.addboss.size()),
                                    2000 + (fightMNG.getLevelTeam() * 20), (short) (Until.nextInt(100, fightMNG.mapMNG.Width - 100)),
